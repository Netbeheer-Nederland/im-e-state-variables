# Contributing to im-e-state-variables

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
im-e-state-variables. These guidelines are not strict rules.
...
The im-e-state-variables team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the im-e-state-variables technical leads
...
[issues]: https://github.com/Netbeheer-Nederland/im-e-state-variables/issues/
[pulls]: https://github.com/Netbeheer-Nederland/im-e-state-variables/pulls/
